(function(){
    ...
    a="countdown-active",e,c,n,j,d,l;
    ...
    function h(z){
        var p="",q="",s="",v="",A="",o="",y="",r="",i="",t="",u="",
        x=k(1,1000000),
        w="";
        if("href" in z.attributes){
            w=z.attributes.href.value; //iqda
            p="https://logwork.com/widget/countdown" //error page
        }
        ...
        function f(i,p){
            var o=i.getElementsByTagName("iframe")[0].contentWindow;o.postMessage(p,"*")
        }
        function g(o,i){
            if(o.classList){
                o.classList.add(i)
            ...
            if(p.data.event_id==="js_countdown_show"){
                ...
                if(i!==null){
                    ...
                    if(p.data.page=="not_found"){
                        o.attributes.href.value="https://"+b(o.attributes.href.value)+"/countdown-timer";i.style.width="500px";i.style.height="50px"
